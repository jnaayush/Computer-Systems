...
main(void)
{
  ...
  4c:	6a 01                	push   $0x1
  4e:	e8 5d 03 00 00       	call   3b0 <printf>
    pid = fork();
  ...
  74:	68 c7 06 00 00       	push   $0x6c7
  79:	6a 01                	push   $0x1
  7b:	e8 30 03 00 00       	call   3b0 <printf>
  ...
  85:	53                   	push   %ebx
  86:	53                   	push   %ebx
  87:	68 9b 06 00 00       	push   $0x69b
  8c:	6a 01                	push   $0x1
  8e:	e8 1d 03 00 00       	call   3b0 <printf>
      exit();
  ...
  98:	50                   	push   %eax
  99:	50                   	push   %eax
  9a:	68 64 09 00 00       	push   $0x964
  9f:	68 ae 06 00 00       	push   $0x6ae
  a4:	e8 1e 02 00 00       	call   2c7 <exec>
      printf(1, "init: exec sh failed\n");
  a9:	5a                   	pop    %edx
  aa:	59                   	pop    %ecx
  ab:	68 b1 06 00 00       	push   $0x6b1
  b0:	6a 01                	push   $0x1
  b2:	e8 f9 02 00 00       	call   3b0 <printf>
      exit();
...
main(void)
{
  ...
  bd:	6a 01                	push   $0x1
  bf:	6a 01                	push   $0x1
  c1:	68 80 06 00 00       	push   $0x680
  c6:	e8 0c 02 00 00       	call   2d7 <mknod>
    open("console", O_RDWR);
  cb:	58                   	pop    %eax
  cc:	5a                   	pop    %edx
  cd:	6a 02                	push   $0x2
  cf:	68 80 06 00 00       	push   $0x680
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 35f:	f7 f1                	div    %ecx
 361:	8a 92 d8 06 00 00    	mov    0x6d8(%edx),%dl
...
putc(int fd, char c)
{
 ...
 50e:	e9 44 ff ff ff       	jmp    457 <printf+0xa7>
        ...
        if(s == 0)
          s = "(null)";
 513:	bf d0 06 00 00       	mov    $0x6d0,%edi
...
free(void *ap)
{
 ...
 528:	a1 6c 09 00 00       	mov    0x96c,%eax
...
free(void *ap)
{
 ...
 555:	89 08                	mov    %ecx,(%eax)
  freep = p;
 557:	a3 6c 09 00 00       	mov    %eax,0x96c
}
 55c:	5b                   	pop    %ebx
 55d:	5e                   	pop    %esi
 55e:	5f                   	pop    %edi
...
free(void *ap)
{
 ...
 590:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 592:	a3 6c 09 00 00       	mov    %eax,0x96c
}
 597:	5b                   	pop    %ebx
 598:	5e                   	pop    %esi
 599:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 5ae:	46                   	inc    %esi
  if((prevp = freep) == 0){
 5af:	8b 15 6c 09 00 00    	mov    0x96c,%edx
 ...
 5d9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 5db:	3b 05 6c 09 00 00    	cmp    0x96c,%eax
...
morecore(uint nu)
{
 ...
 610:	e8 07 ff ff ff       	call   51c <free>
  return freep;
 615:	8b 15 6c 09 00 00    	mov    0x96c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 634:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 637:	89 15 6c 09 00 00    	mov    %edx,0x96c
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 654:	eb e1                	jmp    637 <malloc+0x9b>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 656:	c7 05 6c 09 00 00 70 	movl   $0x970,0x96c
 65d:	09 00 00 
 660:	c7 05 70 09 00 00 70 	movl   $0x970,0x970
 667:	09 00 00 
    base.s.size = 0;
 66a:	c7 05 74 09 00 00 00 	movl   $0x0,0x974
 671:	00 00 00 
 674:	b8 70 09 00 00       	mov    $0x970,%eax
