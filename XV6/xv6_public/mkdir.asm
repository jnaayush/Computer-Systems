...
main(int argc, char *argv[])
{
  ...
  2b:	ff 33                	pushl  (%ebx)
  2d:	e8 51 02 00 00       	call   283 <mkdir>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 2eb:	f7 f1                	div    %ecx
 2ed:	8a 92 48 06 00 00    	mov    0x648(%edx),%dl
...
putc(int fd, char c)
{
 ...
 49a:	e9 44 ff ff ff       	jmp    3e3 <printf+0xa7>
        ...
        if(s == 0)
          s = "(null)";
 49f:	bf 3f 06 00 00       	mov    $0x63f,%edi
...
free(void *ap)
{
 ...
 4b4:	a1 dc 08 00 00       	mov    0x8dc,%eax
...
free(void *ap)
{
 ...
 4e1:	89 08                	mov    %ecx,(%eax)
  freep = p;
 4e3:	a3 dc 08 00 00       	mov    %eax,0x8dc
}
 4e8:	5b                   	pop    %ebx
 4e9:	5e                   	pop    %esi
 4ea:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 53a:	46                   	inc    %esi
  if((prevp = freep) == 0){
 53b:	8b 15 dc 08 00 00    	mov    0x8dc,%edx
 ...
 565:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 567:	3b 05 dc 08 00 00    	cmp    0x8dc,%eax
...
morecore(uint nu)
{
 ...
 59c:	e8 07 ff ff ff       	call   4a8 <free>
  return freep;
 5a1:	8b 15 dc 08 00 00    	mov    0x8dc,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 5c0:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 5c3:	89 15 dc 08 00 00    	mov    %edx,0x8dc
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 5e0:	eb e1                	jmp    5c3 <malloc+0x9b>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 5e2:	c7 05 dc 08 00 00 e0 	movl   $0x8e0,0x8dc
 5e9:	08 00 00 
 5ec:	c7 05 e0 08 00 00 e0 	movl   $0x8e0,0x8e0
 5f3:	08 00 00 
    base.s.size = 0;
 5f6:	c7 05 e4 08 00 00 00 	movl   $0x0,0x8e4
 5fd:	00 00 00 
 600:	b8 e0 08 00 00       	mov    $0x8e0,%eax
